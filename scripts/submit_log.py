...
try:
    ...
    # Hooks may run with a system Python that does not have python-dotenv
    # installed.  Keep the hook self-contained with a small .env fallback.
...
LOG_DIR = PROJECT_ROOT / os.environ.get("AI_LOG_DIR", ".ai-log")
