...
> **Sơ đồ mẫu của repository.** Xem [`LABEL_GUARDIAN_ARCHITECTURE.md`](LABEL_GUARDIAN_ARCHITECTURE.md) để biết kiến trúc mục tiêu và ranh giới trách nhiệm hiện hành của dự án.
